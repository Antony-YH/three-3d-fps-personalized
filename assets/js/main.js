...
// ==========================================
// SISTEMA DE CARGA (LOADING MANAGER)
// ==========================================
...
// Se ejecuta cada vez que se descarga un nuevo recurso (mapa, texturas, personaje)
manager.onProgress = function (url, itemsLoaded, itemsTotal) {
    const progress = (itemsLoaded / itemsTotal) * 100;
    progressBar.style.width = progress + '%';
    loadingText.innerText = `Cargando recursos: ${Math.round(progress)}%`;
};

// Se ejecuta cuando TODO ha terminado de cargar
manager.onLoad = function () {
    loadingText.innerText = 'SISTEMA LISTO';

    // Le damos medio segundo de pausa para que el usuario vea el 100%
    setTimeout(() => {
        // Agregamos la clase que hace el fundido (fade out)
        loadingScreen.classList.add('fade-out');
    }, 500);
};

// ==========================================
// APLICAR EL MANAGER A NUESTRO LOADER
// ==========================================
const loader = new GLTFLoader(manager).setPath('./assets/models/gltf/');
